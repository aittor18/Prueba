...
INSERT INTO desarrolladora VALUES ('BuggySoft');
INSERT INTO juego VALUES 
(0, 'Las aventuras del capitan Salami', 'BuggySoft'),
(1, 'Las aventuras del capitán Salami - Vegan ed.', 'BuggySoft');
INSERT INTO personaje VALUES
	('Cap. Salami', 10.0, 0),
	('Señor Cuchiller', 10.0, 0),
	('Cap. Seitán', 10.0, 1),
	('Cap. Cucharilla', 10.0, 1);
	
SELECT * FROM personaje;

DELETE FROM desarrolladora WHERE
SELECT * FROM juego;
